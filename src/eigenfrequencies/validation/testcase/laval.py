"""Laval disc experimental validation (free-free modal analysis).

Ported from ``turbine_runner/validate_testcase.py``.
"""
...
def run_validation() -> dict:
    ...
    if output_config.save_xdmf:
        write_results_xdmf_vtk(solver, elastic_f, elastic_v, output_config)
