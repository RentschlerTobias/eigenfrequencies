"""Convert an STL surface into a 3-D volume mesh.
...
Usage (container, from repo root):
    python3 -m eigenfrequencies.io.stl_to_msh                      # defaults
    TESTCASE_ELEMENT_SIZE=0.003 python3 -m eigenfrequencies.io.stl_to_msh
"""
...
DEFAULT_STL = os.path.join(_REPO_ROOT, "TestCaseGeomertyMesh.stl")
DEFAULT_MSH = os.path.join(_REPO_ROOT, "turbine_runner", "data", "testcase_volume.msh")
