...
from eigenfrequencies.config import DesignConfig, OptimizationConfig
from eigenfrequencies.penalty.band import band_report
from eigenfrequencies.penalty.objective import compute_penalty
