...
::: {.notes}
This is the final report of my three-month Stuttgart–Laval exchange within DFG Priority Programme SPP 2353. The overarching programme theme: AI-driven shape optimisation and island-model parallelisation for hydraulic machines.
...
With thanks to
  ...
  - Université Laval
  - HEKI 
  - DFG Priority Programme SPP 2353
...
Long-term: unsteady CFD, full FSI, forced-response amplitude, and fatigue analysis. Thanks to DFG SPP 2353, IHS Stuttgart, Université Laval and HEKI — and especially to the Laval group for the validation data and an excellent exchange.
:::
